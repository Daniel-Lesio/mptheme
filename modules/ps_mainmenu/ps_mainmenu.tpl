...
{if $nodes|count }
<ul class=" 
{if $depth == 0}top-menu nav nav--main bg-primary px-lg-2 {else}nav--level-{$depth} {/if}
{if $depth ==1}   d-flex flex-wrap {/if}
{if $depth == 3}
d-none
{/if}
...
{if $depth == 1 } style='padding : 0  ;margin : 0 ;width : 20% ; padding : 10px'  {/if}}
...
<div class=" parent-element bg-primary menu js-top-menu position-static hidden-sm-down"       id="_desktop_top_menu">
